...
echo "\n[1/9] Updating package repositories and upgrading system..."
...
echo "\n[4/9] Applying DRM modeset parameters to /boot/loader.conf..."
...
echo "\n[5/9] Inspecting and configuring /proc file system..."
...
echo "\n[6/9] Assigning permission groups for user 'hema'..."
...
echo "\n[7/9] Unleashing sudo privileges for wheel group members..."
...
echo "\n[8/9] Generating Xorg configuration overrides (20-nvidia.conf)..."
...
echo "\n[9/9] Rebuilding the system font cache..."
fc-cache -f
